...
- **Race positions are the distilled nets' relative weak point.** [exp015](#exp015)'s per-game-plan PR breakdown shows both distilled nets doing relatively worst on pure-race positions (exp014 1.13, exp011b 0.85) versus GNUBG's near-perfect race play (2-ply 0.05, 0-ply 0.16) — 5–7×, the largest relative gap of any game plan, and a surprising one, since races have no contact and should be the easiest category for a value function to get right. Unexplored: whether this is a labeling artifact of the benchmark's race positions specifically, or a genuine weakness in how either distilled net handles pure races.
