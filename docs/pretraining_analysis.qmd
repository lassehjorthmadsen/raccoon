...
**What's next.** The corrected picture — a real ~0.05 handicap below the 0-ply teacher — reframes the roadmap: (1) close the residual with on-policy DAgger; (2) break the teacher ceiling via **TD self-play from this near-parity seed** ([exp013](training_analysis.qmd#exp013) — does it climb above 0-ply, or decay to exp010's ~−0.3 attractor?) and **2-ply distillation** (a warm-start fine-tune on self-generated 2-ply labels).
