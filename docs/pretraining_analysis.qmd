...
**Results.** The winning checkpoint (six-outcome head, epoch 3), benchmarked at large n:

| exp011b winner (six-outcome / ep3) | vs GNUBG-0-ply | vs GNUBG-2-ply |
|---|---|---|
| equity/game | **−0.053 ± 0.046** (n=6000) | **−0.064 ± 0.11** (n=1000) |

The two value heads are **statistically tied** — confirmed at n=6000: scalar/ep3 = **−0.050 ± 0.046** and six-outcome/ep3 = **−0.053 ± 0.046**, 0.003 apart. (The n=1000 selection sweep had read −0.010 vs +0.001; the six-outcome head was the marginally-selected winner, its "+0.001" winner's-curse-inflated — honest value −0.053.)
...
**What's next.** Going *past* the 0-ply teacher needs a signal *stronger* than 0-ply: **TD self-play from this near-parity seed** ([exp013](training_analysis.qmd#exp013) — does it climb above 0-ply, or decay to exp010's ~−0.3 attractor?) and **2-ply distillation** (a warm-start fine-tune on self-generated 2-ply labels).
