"""Encode a BoardView into a (16, 2, 12) tensor for the neural network."""
...
def encode_state(board_view: BoardView) -> np.ndarray:
    """Encode a board position as a (16, 2, 12) float32 tensor.
    ...
    Channels:
        ...
        15: doubles flag
    """
    tensor = np.zeros((16, 2, 12), dtype=np.float32)
...
def encode_batch(board_views: list[BoardView]) -> np.ndarray:
    """Encode multiple board positions. Returns shape (N, 16, 2, 12)."""
