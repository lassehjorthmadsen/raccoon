...
A backgammon AI engine that uses AlphaZero-style reinforcement learning to outperform GNUBG at money game play. The name "Raccoon" is a nod to the doubling cube term in backgammon.
